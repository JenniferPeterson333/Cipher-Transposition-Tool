...
dictionaryname = input("Enter dictionary file name (full path): ")
file = open(dictionaryname, "r")
...
outputname = input("If you would like possible solutions stored to an output file, enter output file name (full path) or n for no:")
...
for j in genobjstr:
	...
	if counter >= numberofwords:
		print ("We found: ", templist)
		finalstring += tempstring
		print (finalstring)
		print (counter, "word(s)")
		ask = input("Write possible solution to a file? Press y for yes and n for no and then press enter: ")
		if ask == "y":
			myfile = open('/home/nancy/zodiak/python/PossibleSolutions.txt', 'a')
